...
namespace Arduino
{
    ...
    public class CustomCombobox : UserControl
    {
        ...
        public CustomCombobox() {
            ...
            cmbList.ForeColor = listTextColor;
            cmbList.SelectedIndexChanged += new EventHandler(ComboBoxSelectedIndexChanged);
            cmbList.TextChanged += new EventHandler(ComboBoxTextChanged);
            ...
            labelText.Click += new EventHandler(Surface_Click); // select item
